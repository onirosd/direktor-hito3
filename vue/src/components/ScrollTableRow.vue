  ...
  <tr>
    ...
    <td>
      <div class="flex relative">
        <input type="text" class="w-full border border-[#8A9CC9] px-2 h-10 rounded" placeholder="Materiales" />
        <img src="../assets/images/icons/ic_arrow-down.svg" class="absolute top-1/2 -translate-y-1/2 right-2" alt="">
      </div>
    </td>
